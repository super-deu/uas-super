<?php
/**
 * Kartu satu item menu. Expects $item (array baris menu_items + category_slug).
 * Dipakai oleh menu.php dan index.php (preview).
 */
?>
<div class="col-sm-6 col-lg-4 all <?= e($item['category_slug']) ?>">
  <div class="box">
    <div>
      <div class="img-box">
      ...
      <div class="detail-box">
        ...
        <div class="options">
          <h6>$<?= number_format((float)$item['price'], 0) ?></h6>
          <a href="#">
